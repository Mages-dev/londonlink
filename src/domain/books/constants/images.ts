...
export const BOOKS_IMAGE_ALTS = {
  covers: {
    threeLionsPart1: "Three Lions English Part 1 Book Cover",
    threeLionsPart2: "Three Lions English Part 2 Book Cover",
    threeLionsPart3: "Three Lions English Part 3 Book Cover",
  },
  previews: {
  ...
  thumbnails: {
    ...
    threeLionsPart2Thumb: "Three Lions English Part 2 Thumbnail",
    threeLionsPart3Thumb: "Three Lions English Part 3 Thumbnail",
  },
} as const;
