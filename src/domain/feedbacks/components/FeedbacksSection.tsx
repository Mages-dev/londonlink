    ...
    <section id="feedbacks" className="relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="relative mb-20">
          <div className="relative bg-white/10 backdrop-blur-sm rounded-2xl p-8 shadow-2xl max-w-4xl mx-auto min-h-[350px]">
            {/* Quote Icon */}
            <div className="quote-icon">&ldquo;</div>

            {/* Current Testimonial */}
            <div className="testimonial-text h-full flex items-center py-4">
                  ...
                  <OptimizedImage
                    src={
                      currentTestimonial === 0
                        ? FEEDBACKS_IMAGES.testimonials.michelleMedeiros
                        : currentTestimonial === 1
                        ? FEEDBACKS_IMAGES.testimonials.rodolphoNiceto
                        : currentTestimonial === 2
                        ? FEEDBACKS_IMAGES.testimonials.henriqueMenezes
                        : FEEDBACKS_IMAGES.testimonials.aylaReis
                    }
                    alt={
                      currentTestimonial === 0
                        ? FEEDBACKS_IMAGE_ALTS.testimonials.michelleMedeiros
                        : currentTestimonial === 1
                        ? FEEDBACKS_IMAGE_ALTS.testimonials.rodolphoNiceto
                        : currentTestimonial === 2
                        ? FEEDBACKS_IMAGE_ALTS.testimonials.henriqueMenezes
                        : FEEDBACKS_IMAGE_ALTS.testimonials.aylaReis
                    }
                    width={200}
                    height={250}
                    className="w-full max-w-48 h-60 object-cover rounded-lg shadow-lg border-4 border-red-600 transition-all duration-500 ease-in-out"
                  />
                </div>
