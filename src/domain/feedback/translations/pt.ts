...
export const feedbackTranslationsPt = {
  ...
  // Statistics
  stats: {
    title: "Nossos Números de Sucesso",
    items: [
      {
        number: "500+",
        label: "Alunos Satisfeitos",
        description: "Alunos que alcançaram seus objetivos no inglês",
      },
      {
        number: "95%",
        label: "Taxa de Sucesso",
        description: "Alunos que passam em seus exames alvo",
      },
      {
        number: "4.9/5",
        label: "Avaliação Média",
        description: "Baseado no feedback dos alunos",
      },
      {
        number: "15+",
        label: "Anos de Experiência",
        description: "Ensinando inglês para alunos brasileiros",
      },
    ],
  },
