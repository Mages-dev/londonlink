// Goals section - English translations
...
export const goalsTranslationsEn = {
  ...
  goals: [
    ...
    {
      icon: 'career',
      title: 'Business English lessons tailored to your career?',
      description: 'Industry-specific English training for career advancement.',
    },
    {
      icon: 'deadline',
  ...
  section2: {
    title: 'We will help you achieve all your goals!',
    description:
      "Whether it's a trip abroad, work, taking an exam, improving language communication, starting from zero, or whatever you want to achieve, we'll design the right course to get you where you've always wanted to be.",
    ctaButton: 'I want to enroll',
  },
} as const;
